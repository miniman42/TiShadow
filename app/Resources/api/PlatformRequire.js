...
exports.file = function(extension) {
  ...
  if( (extension.indexOf("sfo.png") !== -1) || (extension.indexOf("background.png") !== -1) || (extension.indexOf("background.jpg") !== -1) || (extension.indexOf("sfo-bluer.png") !== -1)){
     return extension;
  }
...
(function(context) {
  ...
  context.runSpecNoClearCache = function() {
    var path_name = require('/api/TiShadow').currentApp.replace(/ /g,"_");
    require("/api/Spec").runNoClearCache(path_name, false);
  };  
